...
function markSaveVersionV60(){if(G)G.saveVersion="8.8.3";}
function normalize(){
...
function initPlayer(d){
 ...
 // V8.8.3：五項基礎能力各自隨機 50～70，且平均至少 60。
 // 不再額外贈送 10 點初始配點。
...
function render(){
 ...
 // V8.8.3：render 主流程只做安全的 data-theme 同步，避免主題函式錯誤中斷整個遊戲資料渲染。
